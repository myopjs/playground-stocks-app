...
// node_modules/@myop/react/dist/index.js
...
var te = (e, t, s) => t in e ? Re(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
var w = (e, t) => {
  for (var s in t || (t = {}))
...
var Mt = (e, t) => {
  for (var s in t)
    Re(e, s, { get: t[s], enumerable: true });
};
var o = (e, t, s) => te(e, typeof t != "symbol" ? t + "" : t, s);
var y = (e, t, s) => new Promise((n, i) => {
  var r = (c) => {
    try {
      l(s.next(c));
    } catch (d) {
...
var _t = (e) => new Promise((t) => setTimeout(t, e));
var _ = class {
};
o(_, "down", "down");
o(_, "up", "up");
var M = class {
  constructor() {
    o(this, "id", B()), o(this, "myop", true), o(this, "content"), o(this, "source"), o(this, "destination"), o(this, "route"), o(this, "ref"), o(this, "direction"), o(this, "cleanable", false);
  }
  static create(...t) {
    return new this(...t);
  }
...
var N = class ke {
  constructor(t, s) {
    this.refConfig = t, this.component = s, o(this, "myop", true), o(this, "__nonProxied"), this.__nonProxied = W(w({}, this), {
      component: null
...
var De = "ClickReplayMessage";
var St = class extends S {
  constructor(e, t) {
    super(t), this.ref = e, o(this, "replyMessageKey", De), o(this, "messageType", "BindClickMessage"), o(this, "cleanable", true);
  }
};
...
var Le = "ExecuteScriptReplyMessage";
var Tt = /(?:function\s*\w*\s*\([^)]*\)\s*\{([\s\S]*?)\}|(\([^)]*\)\s*=>\s*\{([\s\S]*?)\}))\s*$/;
var xt = /\(\s*[^)]+\s*\)\s*=>\s*(.+)/;
var Oe = (e) => {
  let t = e.match(Tt);
  if (t)
...
var Be = "EventListenerCallbackMessage";
var Rt = class extends S {
  // {} // empty
  constructor(e, t, s) {
    super(s), this.ref = e, this.type = t, this.handler = s, o(this, "replyMessageKey", Be), o(this, "messageType", "AddEventListenerMessage"), o(this, "cleanable", true), o(this, "serializableSkeleton", false);
  }
...
var Ae = "ElementValueReplayMessage";
...
var qe = "RefComponentCreatedMessage";
...
var We = "DetectedMyopRefsMessage";
...
var Ge = "GetAttributeReplayMessage";
...
var Pt = class extends M {
  constructor() {
    super(...arguments), o(this, "cleanable", true), o(this, "messageType", "SetResizeObserverMessage");
  }
};
...
var ce = class {
  constructor(e, t, s) {
    this.componentDefinition = e, this.container = t, o(this, "id", ""), o(this, "messageHandlers", {}), o(this, "element"), o(this, "_markedForDisposed", false), o(this, "bind", (i, r) => {
      ...
      const l = this.messageHandlers[i], c = (d) => r(d) ? (a(d), true) : false;
      return l.push(c), () => {
        const d = l.indexOf(c);
        d > -1 && l.splice(d, 1);
      };
    }), o(this, "setInitiated", () => {
      this.isInitiated = true, this._whenInitiatedResolve && this._whenInitiatedResolve();
    }), o(this, "isInitiated", false), o(this, "_whenInitiatedResolve"), o(this, "_whenInitiatedReject"), o(this, "_whenInitiated", new Promise((i, r) => {
  ...
  onMessageReceived(e) {
    if (e.messageType === g.ExecuteComponentMethod) {
      const s = e;
      return this[s.method] ? this[s.method](s.content) : console.log(`method not found ${s.method} on component`, this), true;
    }
  ...
  dispose() {
    if (this.markedForDisposed = true, !this.isInitiated)
      return;
    console.log("disposing component", this.id), this.send(new Xe());
    const e = this.messageHandlers.onDispose;
    e && e.forEach((t) => {
      t(null);
    }), this.messageHandlers = {}, this.id += "_disposed", this.isInitiated = false;
  }
};
var Kt = class {
...
var Ut = (e) => y(void 0, null, function* () {
...
var zt = class {
  constructor() {
    o(this, "messageToHandleAfterInit", []), o(this, "components", {}), o(this, "alwaysPassEnvelopesToHost", false), o(this, "messageCleanupCache", {});
  }
...
var F = (e, t = {}, s = true, n = /* @__PURE__ */ new WeakMap()) => {
  if (re(e))
    return e;
  if (Array.isArray(e)) {
    if (n.has(e))
  ...
  if (e !== null && typeof e == "object") {
    ...
    for (const r in e) {
      ...
      a && (a === true ? (s ? e[r] !== void 0 : e[r]) && (i[r] = F(e[r], true, s, n)) : typeof a == "object" && (i[r] = F(e[r], a, s, n)));
    }
    return i;
  }
  return {};
...
var Ce = (e, t, s) => e ? false : (console.error(
  // throw new Error(
  ...
  const n = t.reduce((r, a) => W(w({}, r), {
    ...
    set: (r, a, l) => {
      ...
      if (c.behavior.type === J.code) {
        if (s.loader.type === q.HTMLLoader && s.loader.shadowRootMode === V.localFrame) {
          const u = c.behavior;
          return e.element.contentWindow[u.remap || a] = l, true;
        }
        return Ee(c, a, e), false;
    ...
    return s[n] ? s[n] : (...r) => new Promise((a) => {
      r.forEach((l) => {
        ...
        ({ ref: l, propName: c, functionArgs: d, makeSerializable: u }) => {
          if (l) {
            const h = l[c];
            return u(typeof h == "function" ? l[c](...d) : h, true);
          }
          return null;
        },
        {
...
var st = (e, t, s, n) => y(void 0, null, function* () {
  const i = e.component;
  if (!i)
  ...
  return new Promise((r, a) => y(void 0, null, function* () {
    ...
    i.send(new Ve(
      ...
      (d) => y(void 0, null, function* () {
        ...
        try {
          yield nt(l, t, s, true), i.setHeightBasedOnScrollHeight && i.setHeightBasedOnScrollHeight(), r(l);
        } catch (h) {
          a(h);
        }
      })
...
var nt = (e, t, s, n = false) => y(void 0, null, function* () {
  e.refs || (e.refs = {});
...
var it = class extends ce {
  ...
  onMessageReceived(e) {
    return e.messageType === g.In.MutationObserverMessage || e.messageType === g.In.ResizeObserverMessage ? (this.setHeightBasedOnScrollHeight(), true) : super.onMessageReceived(e);
  }
};
var ue = class {
  constructor() {
...
var P = (e, t) => t.querySelectorAll(`[${z.id}='${e.refConfig.selector}']`);
var ss = class extends I {
  constructor() {
    ...
    super(...arguments), o(this, "messageType", g.CreateRefComponentMessage), o(this, "innerExecutor", (e, t, s) => {
      y(this, null, function* () {
        ...
        if (i.length === 1) {
          ...
          console.error("CreateRefComponentMessageHandler - DOM element not found"), this.messageToHost(new ie(e.handlerUniqueId, [], true));
          debugger;
        }
      }).then();
    });
...
var lt = class extends zt {
  constructor() {
    super(...arguments), o(this, "alwaysPassEnvelopesToHost", true), o(this, "connectedCallback", (e, t) => {
...
var fs = (e) => e.replace(/([a-z])([A-Z])/g, "$1-$2").replace(/(\d+)/g, "-$1").toLowerCase();
var ys = (e) => (e = fs(e), e.replace(/_/g, "-"));
    ...
    super(...arguments), o(this, "type", q.HTMLLoader), o(this, "load", (e, t, s, n) => y(this, null, function* () {
      ...
      if (i.shadowRootMode === V.localFrame) {
        ...
        if (n != null && n._inspection) {
          ...
          C && v.head && v.head.insertBefore(v.importNode(C, true), v.head.firstChild), h = v.documentElement.outerHTML;
        }
...
o(oe, "Main", new oe());
var be = oe;
var ws = (e) => y(void 0, null, function* () {
  try {
...
var dt = "https://cdn.myop.dev/sdk/next/myop_sdk.min.js";
var Z = class {
  constructor() {
    o(this, "components2init", []), o(this, "components", []), o(this, "componentsLoaders", []), o(this, "initiated", false), o(this, "version", ts), o(this, "type2InstanceCount", {}), o(this, "assignId", (e) => (this.type2InstanceCount[e.id] || (this.type2InstanceCount[e.id] = 0), `${e.id}_${++this.type2InstanceCount[e.id]}`)), o(this, "inspected", false), o(this, "inspect", () => {
      this.inspected || (this.inspected = true, this.components.forEach((e) => {
        e.inspect && e.inspect();
      }));
      ...
      window.addEventListener(
        ...
        false
      ), console.log("myop hostSDK initiated", document.location.href), this.initiated = true;
        ...
        case U.Segmented:
          {
            const c = yield a(s.segments, (d) => y(this, null, function* () {
              if (d.segmentId === "Default")
                return true;
              const u = n.find((v) => v.type === Qe.Segment ? v.segment.id === d.segmentId : false);
              if (!u)
                throw new Error("experience not found");
              const m = u.segment, f = (i || {})[m.function];
              return f ? yield f() : (console.warn(`segmentId:${d.segmentId}, ${m.function} function not provided !`), false);
            }));
            if (c)
      ...
      m.isInitiated || this.components2init.push(m), m.bind("onDispose", () => (this.components = this.components.filter((f) => f !== m), this.components2init = this.components2init.filter((f) => f !== m), true)), this.components.push(m), (!s || s.connectProps !== false) && (m = Jt(m, e.type.props, u));
      try {
...
var Cs = (e, t, s) => t in e ? Ms(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
var p = (e, t, s) => Cs(e, typeof t != "symbol" ? t + "" : t, s);
var x = (e, t, s) => new Promise((n, i) => {
  var r = (c) => {
    try {
      l(s.next(c));
    } catch (d) {
...
var D = () => "10000000-1000-4000-8000-100000000000".replace(
  /[018]/g,
  (e) => (+e ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> +e / 4).toString(16)
);
var Es = class {
  constructor() {
    p(this, "id", D()), p(this, "myop", true), p(this, "content"), p(this, "source"), p(this, "destination"), p(this, "route"), p(this, "ref"), p(this, "direction"), p(this, "cleanable", false);
  }
  static create(...e) {
    return new this(...e);
  }
...
var _s = class extends Es {
  constructor(e) {
    super(), this.handler = e, p(this, "handlerUniqueId", D());
  }
};
var bs = "ExecuteScriptReplyMessage";
var Ss = /(?:function\s*\w*\s*\([^)]*\)\s*\{([\s\S]*?)\}|(\([^)]*\)\s*=>\s*\{([\s\S]*?)\}))\s*$/;
var Is = /\(\s*[^)]+\s*\)\s*=>\s*(.+)/;
var Ts = (e) => {
  let t = e.match(Ss);
  if (t)
...
var X = ae;
var Ws = (e) => {
  const t = (0, import_react.useRef)(null), s = (0, import_react.useRef)(null), n = (0, import_react.useRef)(false), i = (0, import_react.useRef)(null);
  return (0, import_react.useEffect)(() => {
    ...
    const a = async (l) => {
      ...
      try {
        ...
        if (n.current = false, i.current !== null && !r) {
          const c = i.current;
    ...
    return n.current ? i.current = { ...e } : a(e).then(), () => {
      r = true, s.current && s.current.dispose();
    };
  }, [e.flowId, e.componentId]), (0, import_jsx_runtime.jsx)(
    "div",
    {
      style: {
        height: "100%",
...
var ht = () => (0, import_jsx_runtime.jsx)(
  "svg",
  {
    width: "80",
    viewBox: "0 0 525 243",
...
var ks = ({
  ...
  fadeDuration: t = 200,
  children: s
}) => s !== void 0 ? (0, import_jsx_runtime.jsx)(
  "div",
  {
    style: {
      ...Hs,
...
var Ls = ({ children: e }) => e !== void 0 ? (0, import_jsx_runtime.jsx)("div", { style: $s, children: e }) : (0, import_jsx_runtime.jsx)("div", { style: Ds, children: (0, import_jsx_runtime.jsx)(ht, {}) });
var Os = (e) => `on${e.split("-").map((s) => s.charAt(0).toUpperCase() + s.slice(1)).join("")}`;
var js = (e) => {
  const t = (0, import_react.useRef)(null), s = (0, import_react.useRef)(null), n = (0, import_react.useRef)(false), i = (0, import_react.useRef)(null), r = e.componentId ? Fs(e.componentId, e.environment, e.preview) : false, [a, l] = (0, import_react.useState)(!r), [c, d] = (0, import_react.useState)(1), [u, h] = (0, import_react.useState)(false), [m, f] = (0, import_react.useState)(false), v = e.fadeDuration ?? 200, O = (0, import_react.useCallback)(() => {
    d(0), setTimeout(() => {
      l(false);
    }, v);
  }, [v]), A = (0, import_react.useCallback)(
    (C) => {
      console.error("[MyopComponent] Error:", C), O(), h(true), e.onError && e.onError(C);
    },
    [O, e.onError]
  );
  return (0, import_react.useEffect)(() => {
  ...
  }, [e.data, m]), (0, import_react.useEffect)(() => {
    let C = false;
    n.current = !(t != null && t.current);
    const pe = async (T) => {
      n.current = true;
      try {
        ...
        if (s.current = await he.loadComponent(
          ...
          if (f(true), O(), s.current && (s.current.props.myop_cta_handler = (K, me) => {
            e.on && e.on(K, me);
        ...
        if (n.current = false, i.current !== null && !C) {
          const $ = i.current;
    ...
    return n.current ? i.current = { ...e } : pe(e).then(), () => {
      C = true, s.current && s.current.dispose();
    };
  }, [e.componentId]), (0, import_jsx_runtime.jsxs)(
    "div",
    {
      style: {
        position: "relative",
      ...
      children: [
        ...
        a && (0, import_jsx_runtime.jsx)(ks, { opacity: c, fadeDuration: v, children: e.loader }),
        u && (0, import_jsx_runtime.jsx)(Ls, { children: e.fallback })
      ]
    }
  );
};
var L = X.Main;
var xe = () => L;
var Fs = (e, t, s) => L.isPreloaded(e, t, s);
var Gs = () => {
...
var Xs = async (e, t, s) => Promise.allSettled(
...
//# sourceMappingURL=@myop_react.js.map
